...
const AddLiquidity: React.FC<{
  ...
  const nativeCurrency = Token.MONAD[chainIdToUse]
  ...
  const handleCurrencyASelect = useCallback(
    (currencyA: any) => {
      const isSwichRedirect = currencyEquals(currencyA, MONAD[chainIdToUse])
        ? currency1Id === 'ETH'
        : currency1Id &&
          currencyA &&
          currencyA.address &&
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: any) => {
      const isSwichRedirect = currencyEquals(currencyB, MONAD[chainIdToUse])
        ? currency0Id === 'ETH'
        : currencyB &&
          currencyB.address &&
          currency0Id &&
