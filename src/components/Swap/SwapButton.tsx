...
import { ChainId, ETH, NativeCurrency, Token, WMND } from '@monadex/sdk'
...
const SwapButton = (props: Props): JSX.Element => {
  ...
  const buttonState = useMemo(() => {
    ...
    if (showWrap) {
      if (wrapInputError !== undefined && wrapInputError !== '') return { text: wrapInputError, action: () => {}, disabled: true }
    ...
    switch (approval) {
      ...
      case ApprovalState.APPROVED:
        return {
          ...
          action: onSwap,
          disabled: !isValid || !(swapCallbackError == null || swapCallbackError === '') // TODO: check if it works
        }
      default:
